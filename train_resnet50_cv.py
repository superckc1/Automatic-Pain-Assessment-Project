...
from data_preprocessing_resnet50_cv import PainDataset, transform

logging.basicConfig(filename='/cs/home/alykc8/resnet50_cv_training2.log', level=logging.INFO, format='%(asctime)s %(message)s')
...
for train_index, val_index in kf.split(subject_ids):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_loss:
            best_loss = val_loss
            torch.save(model.state_dict(), f'/cs/home/alykc8/models/best_resnet50_model_fold_{fold}.pth')
